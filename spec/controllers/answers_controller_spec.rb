  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved answer as @answer" do
        ...
        post :create, {:answer => { "desc" => "invalid value" }}, valid_session
        assigns(:answer).should be_a_new(Answer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested answer" do
        ...
        Answer.any_instance.should_receive(:update_attributes).with({ "desc" => "MyText" })
        put :update, {:id => answer.to_param, :answer => { "desc" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the answer as @answer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Answer.any_instance.stub(:save).and_return(false)
        put :update, {:id => answer.to_param, :answer => { "desc" => "invalid value" }}, valid_session
        assigns(:answer).should eq(answer)
      end
